                ...
                <div class="panel-body">
                    <form role="form" id="addUserForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fusername" placeholder="请输入真实姓名"
                                   style="margin-top:10px;">
                        </div>
                        <div class="form-group">
                            <label for="femail">邮箱地址</label>
                            <input type="text" class="form-control" id="femail" placeholder="请输入邮箱地址"
                                   style="margin-top:10px;">
                            <p class="help-block label label-warning">请输入合法的邮箱地址, 格式为： xxxx@xxxx.com</p>
                        </div>
                        <button type="button" class="btn btn-success" onclick="addUser()"><i
