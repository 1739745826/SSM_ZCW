        ...
        <div class="row">
            <div class="col-xs-6 col-md-3">
                ...
                <a href="#" class="thumbnail" accttype="0">
                    <img alt="100%x180" src="${APP_PATH}/img/services-box1.jpg" data-holder-rendered="true"
            ...
            <div class="col-xs-6 col-md-3">
                ...
                <a href="#" class="thumbnail" accttype="1">
                    <img alt="100%x180" src="${APP_PATH}/img/services-box2.jpg" data-holder-rendered="true"
                         style="height: 180px; width: 100%; display: block;">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                ...
                <a href="#" class="thumbnail" accttype="2">
                    <img alt="100%x180" src="${APP_PATH}/img/services-box3.jpg" data-holder-rendered="true"
                         style="height: 180px; width: 100%; display: block;">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                ...
                <a href="#" class="thumbnail" accttype="3">
                    <img alt="100%x180" src="${APP_PATH}/img/services-box4.jpg" data-holder-rendered="true"
                         style="height: 180px; width: 100%; display: block;">
                </a>
            </div>
        </div>
        <button type="button" class="btn btn-danger btn-lg btn-block" id="applyBtn">认证申请
        </button>
    </div> <!-- /container -->
    <!-- /END THE FEATURETTES -->
